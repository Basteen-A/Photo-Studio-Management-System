...
<li><a href="#"><i class="fa fa-files-o"></i>Event Categories </a>
<ul>
<li><a href="create-brand.php">Create Event</a></li>
<li><a href="manage-brands.php">Manage Event</a></li>
</ul>
</li>

<li><a href="#"><i class="fa fa-car"></i>Sub Events</a>
					<ul>
						<li><a href="post-avehical.php">Post a Subevents</a></li>
						<li><a href="manage-vehicles.php">Manage Subevents</a></li>
					</ul>
				</li>
