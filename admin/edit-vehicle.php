...
<head>
	...
	<title>Natpu Photography | Admin Edit Event Info</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Edit SubEvent</h2>
...
<div class="form-group">
<label class="col-sm-2 control-label">Event Overview<span style="color:red">*</span></label>
<div class="col-sm-10">
